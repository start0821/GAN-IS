...
parser.add_argument('--dims', type=int, default=2048,
                    choices=list(LeNet5.BLOCK_INDEX_BY_DIM),
...
class NpyPathDataset(torch.utils.data.Dataset):
...
def get_activations(files, model, batch_size=50, dims=120, device='cpu', num_workers=8):
