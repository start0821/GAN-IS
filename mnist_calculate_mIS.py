...
from metrics.classwise_mis import inception_score
...
mIS = inception_score(fake_images, cuda=True, batch_size=32, resize=False, splits=1, classifier=netC, log_logit=True, requires_grad=False)

print(f'mIS ({args.nsamples}) : {mIS}')
