...
IS = inception_score(fake_images, cuda=True, batch_size=64, resize=False, splits=1, classifier=netC, log_logit=True, requires_grad=False)

print(f'IS ({args.nsamples}) : {IS}')
